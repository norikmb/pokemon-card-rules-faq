...
[![uv](https://img.shields.io/badge/uv-fast%20Python%20pkg%20manager-5C4EE5)](https://github.com/astral-sh/uv)
...
実装・運用の詳細は [src/doc.md](src/doc.md) を参照してください。

## ライセンス

このプロジェクトのコードは自由に使用できますが、データの著作権は以下に帰属します。

## 免責事項

当リポジトリは個人が運営するポケモンカードゲームのファンコンテンツであり、株式会社ポケモン他企業様とは一切関係ありません。また、このリポジトリ配下におけるポケットモンスター（ポケモン）及び、ポケモンカードゲームに関する全ての著作権は(株)クリーチャーズ、(株)ポケモンに帰属します。
